...
class UpdateCalendarForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      name: '',
  ...
  handleFormSubmit = async (event) => {
    ...
    try {
      ...
      await this.service.updateCalendar(this.calendarId, name, backgroundColor, borderColor, dragBackgroundColor);
  ...
  render () {
    const { name, backgroundColor, borderColor, dragBackgroundColor, loading, showToast, error } = this.state;
        ...
        {!loading && (
          <Form className="card" onSubmit={this.handleFormSubmit}>
            ...
            <div className="card-footer text-end">
              ...
              <Button variant="primary" type="submit">Update calendar</Button>
            </div>
          </Form>
        )}
      </>
